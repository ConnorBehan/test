[![Build Status](https://dev.azure.com/conorbehan/CinemaBot/_apis/build/status/ConnorBehan.CinemaBot?branchName=master)](https://dev.azure.com/conorbehan/CinemaBot/_build/latest?definitionId=2&branchName=master)
# CinemaBot
This bot has been created using [Microsoft Bot Framework](https://dev.botframework.com), as a final year project.
- Use [LUIS](https://luis.ai) to implement core AI capabilities
- QnAMaker for FAQ based questions
